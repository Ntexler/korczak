...
export const translations = {
  en: {
    ...
    // Graph Views & Lenses (Phase 9)
    graphViews: "Graph Views",
    forceView: "Force",
    hierarchicalView: "Hierarchy",
    radialView: "Radial",
    geographicView: "Geographic",
    sankeyView: "Flow",
    selectRootNode: "Select a concept to use as root",
    noGeographicData: "No geographic data available yet",
    lenses: "Lenses",
    noLens: "None",
    controversyLens: "Controversy",
    recencyLens: "Recency",
    confidenceLens: "Confidence",
    communityLens: "Community",
    gapLens: "Gaps",
    controversyLensDesc: "Highlight disputed connections",
    recencyLensDesc: "Fade old, brighten new",
    confidenceLensDesc: "Size by establishment level",
    communityLensDesc: "Glow by discussion activity",
    gapLensDesc: "Highlight research opportunities",
    proposedConnection: "Proposed connection",
    graphSettings: "Settings",
    minConnections: "Min connections",
    minConfidence: "Min confidence",
    minPapers: "Min papers",
  ...
  he: {
    ...
    // Graph Views & Lenses (Phase 9)
    graphViews: "תצוגות גרף",
    forceView: "כוחות",
    hierarchicalView: "היררכיה",
    radialView: "רדיאלי",
    geographicView: "גיאוגרפי",
    sankeyView: "זרימה",
    selectRootNode: "בחר מושג כשורש לתצוגה",
    noGeographicData: "אין נתונים גיאוגרפיים עדיין",
    lenses: "עדשות",
    noLens: "ללא",
    controversyLens: "מחלוקת",
    recencyLens: "עדכניות",
    confidenceLens: "ביטחון",
    communityLens: "קהילה",
    gapLens: "פערים",
    controversyLensDesc: "הדגש חיבורים שנויים במחלוקת",
    recencyLensDesc: "דעך ישנים, הבהר חדשים",
    confidenceLensDesc: "גודל לפי רמת ביסוס",
    communityLensDesc: "זוהר לפי פעילות קהילתית",
    gapLensDesc: "הדגש הזדמנויות מחקר",
    proposedConnection: "חיבור מוצע",
    graphSettings: "הגדרות",
    minConnections: "מינימום חיבורים",
    minConfidence: "מינימום ביטחון",
    minPapers: "מינימום מאמרים",
    yearRange: "טווח שנים",
    edgeTypes: "סוגי קשרים",
