...
ANALYSIS_PROMPT_FULL_TEXT = """Analyze this academic work for a knowledge graph. You are working from the full text of the paper — extract richer detail and connections than would be possible from an abstract alone. Ground every claim in specific textual evidence.
...
3. CLAIMS: Central claims with evidence basis.
   Format: [{{"claim": str, "evidence_type": "empirical|theoretical|comparative|methodological|meta_analytic", "strength": "strong|moderate|weak", "testable": bool}}]
   - "testable": can this claim be empirically verified or falsified?
   - With full text, extract claims from the results and discussion, not just the abstract.
