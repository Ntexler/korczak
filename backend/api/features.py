...
# Field taxonomy moved to backend/core/fields.py (shared, not API-layer).
# Re-exported here so existing `from backend.api.features import _normalize_field`
# imports keep working.
from backend.core.fields import _normalize_field, CORE_FIELDS, get_field_paper_ids  # noqa: F401
